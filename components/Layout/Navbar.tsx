...
import { Menu, X, BarChart3, History, Home } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
                  ...
                  <Link
                    ...
                    className={`flex items-center space-x-2 px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 ${
                      isActive(item.href)
                        ...
                        : 'text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 hover:bg-white/70 dark:hover:bg-gray-700/50 hover:shadow-md hover:scale-105'
                    }`}
                  >
                    <Icon size={16} />
                    <span>{item.name}</span>
          ...
          <div className="flex items-center space-x-4">
            {/* Avatar utilisateur pour les connectés */}
            {isLoggedIn && user && (
            ...
            {!isLoggedIn && (
              <div className="hidden md:flex items-center space-x-3">
                <Link
                  href="/auth/login"
                  className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white px-4 py-2 rounded-xl text-sm font-medium hover:bg-white/70 dark:hover:bg-gray-700/50 hover:shadow-md transition-all duration-200"
                >
                  Connexion
                </Link>
                <Link
