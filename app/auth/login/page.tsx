          ...
          <div className="mt-6 border-t border-gray-200/50 pt-6">
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-6">
              ...
              <p className="text-sm text-blue-600 mb-2">
                Email: <code className="bg-blue-100 px-2 py-1 rounded-lg font-mono">demo@example.com</code>
              </p>
              <p className="text-sm text-blue-600">
                Mot de passe: <code className="bg-blue-100 px-2 py-1 rounded-lg font-mono">password</code>
              </p>
            </div>
          </div>
        </div>
