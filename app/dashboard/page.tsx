...
export default function DashboardPage() {
  ...
  // Récupérer les statistiques et l'activité récente de l'utilisateur
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 dark:border-gray-700/20 p-6">
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-white text-lg">{user?.name || 'Utilisateur'}</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-300">{user?.email || 'email@example.com'}</p>
